...
export default function ProgramSchedule() {
  ...
  const getEventStyle = (type: string) => {
    switch (type) {
      case "plenary":
        return { bg: "#8B5CF6", light: "#EDE9FE" };
      case "symposia":
        return { bg: "#3B82F6", light: "#DBEAFE" };
      case "oral":
        return { bg: "#10B981", light: "#D1FAE5" };
      case "poster":
        return { bg: "#F59E0B", light: "#FEF3C7" };
      case "ceremony":
        return { bg: "#EC4899", light: "#FCE7F3" };
      case "social":
        return { bg: "#EF4444", light: "#FEE2E2" };
      case "workshop":
        return { bg: "#10B981", light: "#D1FAE5" };
      case "registration":
        return { bg: "#6366F1", light: "#E0E7FF" };
      case "break":
        return { bg: "#9CA3AF", light: "#F3F4F6" };
      default:
        return { bg: "#9CA3AF", light: "#F3F4F6" };
    }
  };
                ...
                <div className="schedule-boxarea">
                  ...
                  <div className="schedule-content">
                    {groupedEvents.map((group, groupIndex) => {
                      ...
                      const firstEventStyle = getEventStyle(
                        group.events[0].type,
                      );
                      ...
                      return (
                        <div
                          key={groupIndex}
                          className={`schedule-row ${isParallel ? "parallel" : ""}`}
                          style={{
                            backgroundColor:
                              groupIndex % 2 === 0 ? "#fff" : "#fafafa",
                          }}
                        >
                          {/* Time Column */}
                          <div
                            ...
                            style={{
                              borderLeft: `4px solid ${firstEventStyle.bg}`,
                            }}
                          >
                            <i
                          ...
                          {/* Events Column(s) */}
                          <div
                            className={`schedule-events ${isParallel ? "multi-column" : ""}`}
                          >
