              ...
              <div className="about-imges">
                ...
                <div className="about-btnarea">
                  ...
                  >
                    ...
                    <br />
                    <div className="space12" />
                    <span style={{ fontSize: "12px" }}>23 Feb 2026</span>
                  </span>
                </div>
              </div>
            </div>
            <div className="col-lg-6">
              <div className="about-header-area heading2">
                ...
                <h2 className="text-anime-style-3">
                  Borderless Pharmacy Practice
                </h2>
                <div className="space16" />
                <p data-aos="fade-left" data-aos-duration={900}>
                  The 25th Asian Conference on Clinical Pharmacy (ACCP 2026)
                  brings together pharmacists, researchers, educators, and
                  healthcare professionals from across Asia and beyond. Join us
                  in Bangkok for three days of inspiring keynotes, cutting-edge
                ...
                >
                  ...
                  <div className="text">
                    ...
                    <div className="space12" />
                    <p>
                      Clinical Pharmacy, Pharmacology, Pharmacy Education,
                      Pharmaceutics, and more research tracks to showcase your
                      work.
                    </p>
                  </div>
                </div>
                ...
                >
                  ...
                  <div className="text">
                    <Link href="/preconference-workshops">
                      Pre-conference Workshops
                    </Link>
                    <div className="space12" />
                    <p>
                      Hands-on workshops on July 9, 2026 covering the latest
                      practices and techniques in clinical pharmacy.
                    </p>
                  </div>
                </div>
                <div className="space32" />
                ...
                >
                  <Link href="/call-for-abstracts" className="vl-btn1">
