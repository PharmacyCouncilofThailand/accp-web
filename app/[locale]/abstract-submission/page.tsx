...
export default function AbstractSubmission() {
  ...
  const categories = useMemo(
    () => [
      ...
      t("categories.communityPharmacy"),
  ...
  const handleCoAuthorChange = useCallback(
              ...
              <div className="row">
                <div className="col-lg-8 m-auto">
                  ...
                  >
                    ...
                    >
                      {t("trackingId")}{" "}
                      <strong style={{ color: "#FFBA00" }}>{trackingId}</strong>
                    </p>
                  </div>
                    ...
                    >
                      ...
                      >
                        <i
                          ...
                          style={{ marginRight: "10px", color: "#FFBA00" }}
                        />
                        Author Information
                      </h4>
                      <div
                      ...
                      >
                        ...
                        <p>
                          <strong>Institution:</strong> {formData.affiliation}
                        </p>
                        <p>
                      ...
                      <div style={{ fontSize: "14px" }}>
                        {formData.background && (
                          <p>
                            ...
                            {formData.background.substring(0, 200)}...
                          </p>
                        )}
                        {formData.methods && (
                          <p>
                            <strong>Methods:</strong>{" "}
                            {formData.methods.substring(0, 200)}...
                          </p>
                        )}
                        {formData.results && (
                          <p>
                            <strong>Results:</strong>{" "}
                            {formData.results.substring(0, 200)}...
                          </p>
                        )}
                        {formData.conclusions && (
                          <p>
                            <strong>Conclusions:</strong>{" "}
                            {formData.conclusions.substring(0, 200)}...
                          </p>
                        )}
                      </div>
                    </div>
      ...
      <div>
        ...
        {isSubmitting && (
          ...
          >
            ...
            />
            <div
              style={{ color: "#1a237e", fontSize: "18px", fontWeight: "600" }}
            >
              {tCommon("loading")}...
            </div>
          </div>
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="submission-section">
                    <h3 className="submission-section-title">
                      <i
                        className="fa-solid fa-user"
                        style={{ marginRight: "12px", color: "#FFBA00" }}
                      />
                      {t("section1Title")}
                    </h3>
                      ...
                      <div className="col-12 col-md-6">
                        <div className="submission-input-group">
                          ...
                          >
                            ...
                            <option value="clinical_pharmacy">
                              {t("categories.clinicalPharmacy") ||
                                "Clinical Pharmacy"}
                            </option>
                            <option value="social_administrative">
                              {t("categories.socialAdministrative") ||
                                "Social and Administrative Pharmacy"}
                            </option>
                            <option value="community_pharmacy">
                              {t("categories.communityPharmacy") ||
                                "Community Pharmacy"}
                            </option>
                            <option value="pharmacology_toxicology">
                              {t("categories.pharmacology") ||
                                "Pharmacology and Toxicology"}
                            </option>
                            <option value="pharmacy_education">
                              {t("categories.education") ||
                                "Pharmacy Education"}
                            </option>
                            <option value="digital_pharmacy">
                              {t("categories.digitalPharmacy") ||
                  ...
                  <div className="submission-section">
                    ...
                    <div
                      ...
                      onClick={() =>
                        document.getElementById("abstract-file")?.click()
                      }
                    >
                      <input
                        type="file"
                      ...
                      >
                        <i
                          ...
                          style={{ fontSize: "24px", color: "#FFBA00" }}
                        />
                      </div>
                      <h4
                        style={{
                  ...
                  <div className="submission-section">
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          I confirm that this abstract is my original work and
